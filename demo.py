'''
Script for demonstration of the Mila activation function
...
class Classifier(nn.Module):
    def __init__(self, activation = 'mila'):
        super().__init__()
...
def main():
    '''
    Demonstrate Mila activation function to classify Fashion MNIST
    '''
    ...
    if (model_initialization == 'class'):
        ...
        if (activation == MILA):
            activation_function = mila(beta=-0.25)
